...
.method private startStitchService(Lcom/google/android/apps/lightcycle/storage/LocalSessionStorage;)V
    ...
    .prologue
    .line 497
    iget-boolean v2, p0, Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity;->runInCalibrationMode:Z

    invoke-static {v2}, Lcom/google/android/apps/lightcycle/panorama/LightCycleNative;->FinishCapture(Z)V

    .line 500
    iget-object v2, p0, Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity;->storageManager:Lcom/google/android/apps/lightcycle/storage/StorageManager;

    invoke-interface {v2, p1}, Lcom/google/android/apps/lightcycle/storage/StorageManager;->addSessionData(Lcom/google/android/apps/lightcycle/storage/LocalSessionStorage;)V
    ...
    .line 507
    iget-object v2, p1, Lcom/google/android/apps/lightcycle/storage/LocalSessionStorage;->sessionDir:Ljava/lang/String;

    invoke-static {v2}, Lcom/google/android/apps/lightcycle/panorama/LightCycleNative;->CalibrateFieldOfViewDeg(Ljava/lang/String;)F
    ...
    iget-object v3, p1, Lcom/google/android/apps/lightcycle/storage/LocalSessionStorage;->sessionId:Ljava/lang/String;

    invoke-interface {v2, v3}, Lcom/google/android/apps/lightcycle/storage/StorageManager;->deleteSession(Ljava/lang/String;)V
    ...
    const-string v3, "FOV Calibration failed!"
    ...
    .line 527
    new-instance v2, Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity$7;

    invoke-direct {v2, p0}, Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity$7;-><init>(Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity;)V

    invoke-virtual {v1, v2}, Lcom/google/android/apps/lightcycle/panorama/StitchingServiceManager;->addStitchingResultCallback(Lcom/google/android/apps/lightcycle/panorama/StitchingServiceManager$StitchingResultCallback;)V

    .line 542
    :cond_2
    invoke-virtual {v1, p1}, Lcom/google/android/apps/lightcycle/panorama/StitchingServiceManager;->newTask(Lcom/google/android/apps/lightcycle/storage/LocalSessionStorage;)V

    .line 548
    const v2, 0x7f0b003a

    invoke-virtual {p0, v2}, Lcom/google/android/apps/lightcycle/PanoramaCaptureActivity;->getText(I)Ljava/lang/CharSequence;
