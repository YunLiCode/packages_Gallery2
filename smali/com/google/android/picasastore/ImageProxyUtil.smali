.class public Lcom/google/android/picasastore/ImageProxyUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/picasastore/ImageProxyUtil;->PROXY_HOSTED_IMAGE_URL_RE:Ljava/util/regex/Pattern;
...
.method private static createProxyUrl()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/google/android/picasastore/ImageProxyUtil;->getNextProxyIndex()I
...
.method private static declared-synchronized getNextProxyIndex()I
    ...
    .prologue
    .line 85
    const-class v2, Lcom/google/android/picasastore/ImageProxyUtil;

    monitor-enter v2

    :try_start_0
    sget v1, Lcom/google/android/picasastore/ImageProxyUtil;->sProxyIndex:I

    add-int/lit8 v0, v1, 0x1

    sput v0, Lcom/google/android/picasastore/ImageProxyUtil;->sProxyIndex:I
    ...
    sput v1, Lcom/google/android/picasastore/ImageProxyUtil;->sProxyIndex:I
    :try_end_0
...
.method public static isProxyHostedUrl(Ljava/lang/String;)Z
    ...
    .line 205
    :cond_0
    sget-object v1, Lcom/google/android/picasastore/ImageProxyUtil;->PROXY_HOSTED_IMAGE_URL_RE:Ljava/util/regex/Pattern;
...
.method public static setImageUrlSize(ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 56
    :cond_0
    invoke-static {p1}, Lcom/google/android/picasastore/ImageProxyUtil;->isProxyHostedUrl(Ljava/lang/String;)Z
    ...
    .line 57
    invoke-static {}, Lcom/google/android/picasastore/ImageProxyUtil;->createProxyUrl()Ljava/lang/String;
    ...
    invoke-static {p0, p0, v0, p1}, Lcom/google/android/picasastore/ImageProxyUtil;->setImageUrlSizeOptions(IILandroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
...
.method public static setImageUrlSizeOptions(IILandroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .param p0, "width"    # I
    .param p1, "height"    # I
    .param p2, "proxyUri"    # Landroid/net/Uri;
    ...
    invoke-static {p2}, Lcom/google/android/picasastore/ImageProxyUtil;->getQueryParameterNames(Landroid/net/Uri;)Ljava/util/Set;
