...
.field private mOldScreenTexture:Lcom/android/gallery3d/glrenderer/RawTexture;

.field private final mTransitionSpec:Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;


# direct methods
.method public constructor <init>(Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;Lcom/android/gallery3d/glrenderer/RawTexture;)V
    .locals 1
    .param p1, "spec"    # Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;
    .param p2, "oldScreen"    # Lcom/android/gallery3d/glrenderer/RawTexture;
    ...
    .end local p1    # "spec":Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;
    :goto_0
    ...
    .line 111
    iput-object p2, p0, Lcom/android/gallery3d/anim/StateTransitionAnimation;->mOldScreenTexture:Lcom/android/gallery3d/glrenderer/RawTexture;
    ...
    .line 108
    .restart local p1    # "spec":Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;
    :cond_0
...
.method public constructor <init>(Lcom/android/gallery3d/anim/StateTransitionAnimation$Transition;Lcom/android/gallery3d/glrenderer/RawTexture;)V
    .locals 1
    .param p1, "t"    # Lcom/android/gallery3d/anim/StateTransitionAnimation$Transition;
    .param p2, "oldScreen"    # Lcom/android/gallery3d/glrenderer/RawTexture;

    .prologue
    .line 104
    # invokes: Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;->specForTransition(Lcom/android/gallery3d/anim/StateTransitionAnimation$Transition;)Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;
    ...
    invoke-direct {p0, v0, p2}, Lcom/android/gallery3d/anim/StateTransitionAnimation;-><init>(Lcom/android/gallery3d/anim/StateTransitionAnimation$Spec;Lcom/android/gallery3d/glrenderer/RawTexture;)V

    .line 105
    return-void
.end method

.method private applyOldTexture(Lcom/android/gallery3d/ui/GLView;Lcom/android/gallery3d/glrenderer/GLCanvas;FFZ)V
    .locals 5
    .param p1, "view"    # Lcom/android/gallery3d/ui/GLView;
    ...
    .prologue
    .line 147
    iget-object v2, p0, Lcom/android/gallery3d/anim/StateTransitionAnimation;->mOldScreenTexture:Lcom/android/gallery3d/glrenderer/RawTexture;
    ...
    invoke-interface {p2, v2}, Lcom/android/gallery3d/glrenderer/GLCanvas;->clearBuffer([F)V

    .line 150
    :cond_1
    invoke-interface {p2}, Lcom/android/gallery3d/glrenderer/GLCanvas;->save()V

    .line 151
    invoke-interface {p2, p3}, Lcom/android/gallery3d/glrenderer/GLCanvas;->setAlpha(F)V
    ...
    invoke-interface {p2, v2, v3}, Lcom/android/gallery3d/glrenderer/GLCanvas;->translate(FF)V

    .line 155
    const/high16 v2, 0x3f800000

    invoke-interface {p2, p4, p4, v2}, Lcom/android/gallery3d/glrenderer/GLCanvas;->scale(FFF)V
    ...
    invoke-virtual {v2, p2, v3, v4}, Lcom/android/gallery3d/glrenderer/RawTexture;->draw(Lcom/android/gallery3d/glrenderer/GLCanvas;II)V

    .line 157
    invoke-interface {p2}, Lcom/android/gallery3d/glrenderer/GLCanvas;->restore()V
...
# virtual methods
.method public applyBackground(Lcom/android/gallery3d/ui/GLView;Lcom/android/gallery3d/glrenderer/GLCanvas;)V
    .locals 6
    .param p1, "view"    # Lcom/android/gallery3d/ui/GLView;
    .param p2, "canvas"    # Lcom/android/gallery3d/glrenderer/GLCanvas;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/gallery3d/anim/StateTransitionAnimation;->applyOldTexture(Lcom/android/gallery3d/ui/GLView;Lcom/android/gallery3d/glrenderer/GLCanvas;FFZ)V
...
.method public applyContentTransform(Lcom/android/gallery3d/ui/GLView;Lcom/android/gallery3d/glrenderer/GLCanvas;)V
    .locals 5
    .param p1, "view"    # Lcom/android/gallery3d/ui/GLView;
    .param p2, "canvas"    # Lcom/android/gallery3d/glrenderer/GLCanvas;
    ...
    invoke-interface {p2, v2, v3, v4}, Lcom/android/gallery3d/glrenderer/GLCanvas;->scale(FFF)V
    ...
    invoke-interface {p2, v2}, Lcom/android/gallery3d/glrenderer/GLCanvas;->setAlpha(F)V

    .line 173
    return-void
.end method

.method public applyOverlay(Lcom/android/gallery3d/ui/GLView;Lcom/android/gallery3d/glrenderer/GLCanvas;)V
    .locals 6
    .param p1, "view"    # Lcom/android/gallery3d/ui/GLView;
    .param p2, "canvas"    # Lcom/android/gallery3d/glrenderer/GLCanvas;
...
.method public calculate(J)Z
    ...
    .line 119
    iget-object v1, p0, Lcom/android/gallery3d/anim/StateTransitionAnimation;->mOldScreenTexture:Lcom/android/gallery3d/glrenderer/RawTexture;
    ...
    invoke-virtual {v1}, Lcom/android/gallery3d/glrenderer/RawTexture;->recycle()V

    .line 121
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/gallery3d/anim/StateTransitionAnimation;->mOldScreenTexture:Lcom/android/gallery3d/glrenderer/RawTexture;
