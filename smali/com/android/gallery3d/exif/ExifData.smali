...
.method protected getAllTagsForIfd(I)Ljava/util/List;
    ...
    .line 278
    iget-object v8, p0, Lcom/android/gallery3d/exif/ExifData;->mIfdDatas:[Lcom/android/gallery3d/exif/IfdData;

    aget-object v1, v8, p1

    .line 279
    .local v1, "d":Lcom/android/gallery3d/exif/IfdData;
    if-nez v1, :cond_1
    ...
    .line 287
    .local v4, "ret":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/gallery3d/exif/ExifTag;>;"
    move-object v0, v6
    ...
    .line 288
    .local v5, "t":Lcom/android/gallery3d/exif/ExifTag;
    ...
    .line 290
    .end local v5    # "t":Lcom/android/gallery3d/exif/ExifTag;
    :cond_3
    invoke-virtual {v4}, Ljava/util/ArrayList;->size()I
...
.method protected getAllTagsForTagId(S)Ljava/util/List;
    ...
    .line 310
    .end local v1    # "d":Lcom/android/gallery3d/exif/IfdData;
    :cond_1
    invoke-virtual {v4}, Ljava/util/ArrayList;->size()I
    ...
    .line 313
    .end local v4    # "ret":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/gallery3d/exif/ExifTag;>;"
    :cond_2
    return-object v4
.end method
...
.method protected getUserComment()Ljava/lang/String;
    ...
    .line 217
    iget-object v6, p0, Lcom/android/gallery3d/exif/ExifData;->mIfdDatas:[Lcom/android/gallery3d/exif/IfdData;

    aget-object v3, v6, v8

    .line 218
    .local v3, "ifdData":Lcom/android/gallery3d/exif/IfdData;
    if-nez v3, :cond_1
    ...
    invoke-static {v6}, Lcom/android/gallery3d/exif/ExifInterface;->getTrueTagKey(I)S

    move-result v6

    invoke-virtual {v3, v6}, Lcom/android/gallery3d/exif/IfdData;->getTag(S)Lcom/android/gallery3d/exif/ExifTag;
    ...
    .line 230
    .local v0, "buf":[B
    invoke-virtual {v4, v0}, Lcom/android/gallery3d/exif/ExifTag;->getBytes([B)V
    ...
    .line 236
    :try_start_0
    sget-object v6, Lcom/android/gallery3d/exif/ExifData;->USER_COMMENT_ASCII:[B
    ...
    .line 238
    :cond_2
    sget-object v6, Lcom/android/gallery3d/exif/ExifData;->USER_COMMENT_JIS:[B
    ...
    .line 240
    :cond_3
    sget-object v6, Lcom/android/gallery3d/exif/ExifData;->USER_COMMENT_UNICODE:[B
