...
.method private createRequiredIfdAndTag()V
    ...
    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    const/4 v15, 0x0

    invoke-virtual {v14, v15}, Lcom/android/gallery3d/exif/ExifData;->getIfdData(I)Lcom/android/gallery3d/exif/IfdData;

    move-result-object v6

    .line 324
    .local v6, "ifd0":Lcom/android/gallery3d/exif/IfdData;
    if-nez v6, :cond_0

    .line 325
    new-instance v6, Lcom/android/gallery3d/exif/IfdData;

    .end local v6    # "ifd0":Lcom/android/gallery3d/exif/IfdData;
    const/4 v14, 0x0

    invoke-direct {v6, v14}, Lcom/android/gallery3d/exif/IfdData;-><init>(I)V

    .line 326
    .restart local v6    # "ifd0":Lcom/android/gallery3d/exif/IfdData;
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    invoke-virtual {v14, v6}, Lcom/android/gallery3d/exif/ExifData;->addIfdData(Lcom/android/gallery3d/exif/IfdData;)V

    .line 328
    :cond_0
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mInterface:Lcom/android/gallery3d/exif/ExifInterface;

    sget v15, Lcom/android/gallery3d/exif/ExifInterface;->TAG_EXIF_IFD:I

    invoke-virtual {v14, v15}, Lcom/android/gallery3d/exif/ExifInterface;->buildUninitializedTag(I)Lcom/android/gallery3d/exif/ExifTag;

    move-result-object v2

    .line 329
    .local v2, "exifOffsetTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v2, :cond_1
    ...
    .line 333
    :cond_1
    invoke-virtual {v6, v2}, Lcom/android/gallery3d/exif/IfdData;->setTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;
    ...
    .line 337
    .local v1, "exifIfd":Lcom/android/gallery3d/exif/IfdData;
    if-nez v1, :cond_2

    .line 338
    new-instance v1, Lcom/android/gallery3d/exif/IfdData;

    .end local v1    # "exifIfd":Lcom/android/gallery3d/exif/IfdData;
    const/4 v14, 0x2

    invoke-direct {v1, v14}, Lcom/android/gallery3d/exif/IfdData;-><init>(I)V

    .line 339
    .restart local v1    # "exifIfd":Lcom/android/gallery3d/exif/IfdData;
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    invoke-virtual {v14, v1}, Lcom/android/gallery3d/exif/ExifData;->addIfdData(Lcom/android/gallery3d/exif/IfdData;)V
    ...
    .line 344
    .local v3, "gpsIfd":Lcom/android/gallery3d/exif/IfdData;
    if-eqz v3, :cond_4
    ...
    sget v15, Lcom/android/gallery3d/exif/ExifInterface;->TAG_GPS_IFD:I
    ...
    .line 346
    .local v4, "gpsOffsetTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v4, :cond_3
    ...
    .line 350
    :cond_3
    invoke-virtual {v6, v4}, Lcom/android/gallery3d/exif/IfdData;->setTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;

    .line 354
    .end local v4    # "gpsOffsetTag":Lcom/android/gallery3d/exif/ExifTag;
    :cond_4
    move-object/from16 v0, p0
    ...
    .line 355
    .local v8, "interIfd":Lcom/android/gallery3d/exif/IfdData;
    if-eqz v8, :cond_6
    ...
    sget v15, Lcom/android/gallery3d/exif/ExifInterface;->TAG_INTEROPERABILITY_IFD:I
    ...
    .line 358
    .local v9, "interOffsetTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v9, :cond_5
    ...
    .line 362
    :cond_5
    invoke-virtual {v1, v9}, Lcom/android/gallery3d/exif/IfdData;->setTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;

    .line 365
    .end local v9    # "interOffsetTag":Lcom/android/gallery3d/exif/ExifTag;
    :cond_6
    move-object/from16 v0, p0
    ...
    .line 368
    .local v7, "ifd1":Lcom/android/gallery3d/exif/IfdData;
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    invoke-virtual {v14}, Lcom/android/gallery3d/exif/ExifData;->hasCompressedThumbnail()Z
    ...
    .end local v7    # "ifd1":Lcom/android/gallery3d/exif/IfdData;
    const/4 v14, 0x1

    invoke-direct {v7, v14}, Lcom/android/gallery3d/exif/IfdData;-><init>(I)V

    .line 372
    .restart local v7    # "ifd1":Lcom/android/gallery3d/exif/IfdData;
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    invoke-virtual {v14, v7}, Lcom/android/gallery3d/exif/ExifData;->addIfdData(Lcom/android/gallery3d/exif/IfdData;)V
    ...
    .line 377
    .local v12, "offsetTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v12, :cond_8
    ...
    .line 382
    :cond_8
    invoke-virtual {v7, v12}, Lcom/android/gallery3d/exif/IfdData;->setTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;
    ...
    .line 385
    .local v10, "lengthTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v10, :cond_9
    ...
    invoke-virtual {v14}, Lcom/android/gallery3d/exif/ExifData;->getCompressedThumbnail()[B

    move-result-object v14

    array-length v14, v14

    invoke-virtual {v10, v14}, Lcom/android/gallery3d/exif/ExifTag;->setValue(I)Z

    .line 391
    invoke-virtual {v7, v10}, Lcom/android/gallery3d/exif/IfdData;->setTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;

    .line 394
    sget v14, Lcom/android/gallery3d/exif/ExifInterface;->TAG_STRIP_OFFSETS:I

    invoke-static {v14}, Lcom/android/gallery3d/exif/ExifInterface;->getTrueTagKey(I)S

    move-result v14

    invoke-virtual {v7, v14}, Lcom/android/gallery3d/exif/IfdData;->removeTag(S)V

    .line 395
    sget v14, Lcom/android/gallery3d/exif/ExifInterface;->TAG_STRIP_BYTE_COUNTS:I
    ...
    .line 432
    .end local v10    # "lengthTag":Lcom/android/gallery3d/exif/ExifTag;
    .end local v12    # "offsetTag":Lcom/android/gallery3d/exif/ExifTag;
    :cond_a
    :goto_0
    return-void
    ...
    invoke-virtual {v14}, Lcom/android/gallery3d/exif/ExifData;->hasUncompressedStrip()Z
    ...
    invoke-virtual {v14}, Lcom/android/gallery3d/exif/ExifData;->getStripCount()I

    move-result v13

    .line 402
    .local v13, "stripCount":I
    move-object/from16 v0, p0
    ...
    .line 403
    .restart local v12    # "offsetTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v12, :cond_d
    ...
    .line 409
    .restart local v10    # "lengthTag":Lcom/android/gallery3d/exif/ExifTag;
    if-nez v10, :cond_e
    ...
    invoke-virtual {v14, v5}, Lcom/android/gallery3d/exif/ExifData;->getStrip(I)[B
    ...
    .line 417
    :cond_f
    invoke-virtual {v10, v11}, Lcom/android/gallery3d/exif/ExifTag;->setValue([J)Z
    ...
    .line 421
    sget v14, Lcom/android/gallery3d/exif/ExifInterface;->TAG_JPEG_INTERCHANGE_FORMAT:I
    ...
    .line 422
    sget v14, Lcom/android/gallery3d/exif/ExifInterface;->TAG_JPEG_INTERCHANGE_FORMAT_LENGTH:I
    ...
    .end local v5    # "i":I
    .end local v10    # "lengthTag":Lcom/android/gallery3d/exif/ExifTag;
    .end local v11    # "lengths":[J
    .end local v12    # "offsetTag":Lcom/android/gallery3d/exif/ExifTag;
    .end local v13    # "stripCount":I
    :cond_10
    if-eqz v7, :cond_a
...
.method private writeExifData()V
    ...
    .line 217
    .local v3, "nullTags":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/gallery3d/exif/ExifTag;>;"
    ...
    check-cast v4, Lcom/android/gallery3d/exif/ExifTag;

    .line 239
    .local v4, "t":Lcom/android/gallery3d/exif/ExifTag;
    iget-object v5, p0, Lcom/android/gallery3d/exif/ExifOutputStream;->mExifData:Lcom/android/gallery3d/exif/ExifData;

    invoke-virtual {v5, v4}, Lcom/android/gallery3d/exif/ExifData;->addTag(Lcom/android/gallery3d/exif/ExifTag;)Lcom/android/gallery3d/exif/ExifTag;

    goto :goto_1

    .line 231
    .end local v2    # "i$":Ljava/util/Iterator;
    .end local v4    # "t":Lcom/android/gallery3d/exif/ExifTag;
    :cond_3
    const/16 v5, 0x4949
